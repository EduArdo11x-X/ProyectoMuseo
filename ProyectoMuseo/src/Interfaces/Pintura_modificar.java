...
public class Pintura_modificar extends javax.swing.JFrame {
    ...
    public void buscar(ObjectContainer basep) {//cargardatos
        ...
        if (cod_pintura.getText().isEmpty()) {
            ...
            if (!EAux.verificar(basep, IDAux)) {
                ...
                Pintura Ebuscar = new Pintura(null, null, null, IDAux, null, null, null);
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    cod_artista.setText(miE.getId_artista());
    ...
    public void Modificar_pintura(ObjectContainer basep) {
        ...
        if (validarCampos(basep)) {
            Pintura Emodi = new Pintura(null, null, null, cod_pintura.getText(), null, null, null);
    ...
    public boolean validarCampos(ObjectContainer basep) {
        ...
        if (desc_pintura.getText().isEmpty()) {
            ...
            if (!miValidaciones.validardescripcion(descripcion_pintura)) {
                JOptionPane.showMessageDialog(this, "Descripcion invalida");
                ban_confirmar = false;
            }
        }
    ...
    private void initComponents() {
        ...
        tipo_pint.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tipo_pintActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addComponent(cod_artista, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(22, 22, 22))
    ...
    private void tipo_pintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tipo_pintActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tipo_pintActionPerformed
