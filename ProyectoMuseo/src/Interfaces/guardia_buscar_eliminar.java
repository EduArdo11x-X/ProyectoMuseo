 ...
 * @author Lenovo
 */
public class guardia_buscar_eliminar extends javax.swing.JFrame {

    /**
     * Creates new form guardia_buscar_eliminar
     */
    public guardia_buscar_eliminar() {
        initComponents();
    }
    ...
    public void Filtro(ObjectContainer basep) {
        ...
        if (jCBfiltro.getSelectedIndex() == 0) {
            ...
            if (jCBfiltro.getSelectedIndex() == 1) {
                Guardia Abuscar = new Guardia(null, 0, false, null, null, null, null, null, '\u0000', null, null, null, null, null);
                ...
                if (jCBfiltro.getSelectedIndex() == 2) {
                    ...
                    Guardia Abuscar = new Guardia(jTFid, 0, false, null, null, null, null, null, '\u0000', null, null, null, null, null);
                    ObjectSet result = basep.get(Abuscar);
                    mostrarDatos(result);
    ...
    public void mostrarDatos(ObjectSet result) {
        ...
        if (result.size() == 0) {
            ...
            while (result.hasNext()) {
                ...
                Object[] fila = {
                    ...
                    mitaquillero.getAnios_experiencia(),
     ...
     public void Eliminar_pintura(ObjectContainer basep) {
         guardia_registro Ainterfaz = new guardia_registro();
        if (jTFid.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Ingrese un ID");
        } else {

            String IDA = jTFid.getText();
            Guardia Abuscar = new Guardia(IDA, 0, false, null, null, null, null, null, '\u0000', null, null, null, null, null);
            ObjectSet result = basep.get(Abuscar);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guardia_buscar_eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new guardia_buscar_eliminar().setVisible(true);
            }
        });
    }
