 ...
 * @author Lenovo
 */
public class artista_registrar extends javax.swing.JFrame {

    /**
     * Creates new form artista_registrar
     */
    ...
    public static boolean comprobarID(ObjectContainer BaseD, String id_Artista) {
        Query query = BaseD.query();
        query.constrain(Artista.class);
        query.descend("Id_artista").constrain(id_Artista).equal();
        ObjectSet result = query.execute();
        return !result.isEmpty();
    }
    ...
    private void initComponents() {
        ...
        txtid_guardia.setToolTipText("Ejemplo: AS-1234");
        ...
        combo_provincia.setForeground(new java.awt.Color(0, 0, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(artista_registrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new artista_registrar().setVisible(true);
            }
        });
    }
