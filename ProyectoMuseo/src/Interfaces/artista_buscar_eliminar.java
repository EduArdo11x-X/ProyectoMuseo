 ...
 * @author Lenovo
 */
public class artista_buscar_eliminar extends javax.swing.JFrame {

    /**
     * Creates new form artista_buscar_eliminar
     */
    public artista_buscar_eliminar() {
        initComponents();
    }
    ...
    public void Filtro(ObjectContainer basep) {
        ...
        if (jCBfiltro.getSelectedIndex() == 0) {
            ...
            if (jCBfiltro.getSelectedIndex() == 1) {
                Artista Abuscar = new Artista(null, null, null, null, null, null, null, null, '\u0000', null, null, null, null, null);
                ...
                if (jCBfiltro.getSelectedIndex() == 2) {
                    ...
                    Artista Abuscar = new Artista(jTFid, null, null, null, null, null, null, null, '\u0000', null, null, null, null, null);
                    ObjectSet result = basep.get(Abuscar);
                    mostrarDatos(result);
    ...
    public void mostrarDatos(ObjectSet result) {
        ...
        if (result.size() == 0) {
            ...
            while (result.hasNext()) {
                Artista mitaquillero = (Artista) result.next();
                Object[] fila = {
                    mitaquillero.getId_artista(),
                    ...
                    mitaquillero.getNombre_artistico(),
    ...
    public void Eliminar_pintura(ObjectContainer basep) {
        artista_registrar Ainterfaz = new artista_registrar();
        if (jTFid.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Ingrese un ID");
        } else {

            String IDA = jTFid.getText();
            Artista Abuscar = new Artista(IDA, null, null, null, null, null, null, null, '\u0000', null, null, null, null, null);
            ObjectSet result = basep.get(Abuscar);

            if (!Ainterfaz.comprobarID(basep, IDA)) {
                JOptionPane.showMessageDialog(null, "La Artista no existe en la base de datos");

            } else {
                Artista AsignaturaElim = (Artista) result.next();
                basep.delete(AsignaturaElim);
                JOptionPane.showMessageDialog(null, "La Artista fue anulada exitosamente");
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Seleccione un campo para buscar al Artista");

        jLabel2.setBackground(new java.awt.Color(0, 0, 0));
        jLabel2.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        jLabel2.setText("Filtro");

        buscar_button.setFont(new java.awt.Font("DialogInput", 1, 12)); // NOI18N
        ...
        jLabel3.setText("Consultar y Eliminar Artista");

        jLabel4.setBackground(new java.awt.Color(0, 0, 0));
        jLabel4.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        jLabel4.setText("Ingrese el ID del Artista a eliminar");
        ...
        eliminar_button.setFont(new java.awt.Font("DialogInput", 1, 12)); // NOI18N
        ...
        jtableregistro.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Guardia", "Cedula", "Nombre", "Apellido", "Genero", "Numero Telefono", "Fecha Nacimiento", "Correo", "Años Experiencia", "Disponibilidad", "Provincia", "Ciudad", "Direccion"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(artista_buscar_eliminar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new artista_buscar_eliminar().setVisible(true);
            }
        });
    }
